...
<script src="https://cdn.jsdelivr.net/gh/wf-ping/argon.fanfine.cn@v1.3.5/assets/vendor/jquery/jquery.min.js"></script>
	<script src="https://cdn.jsdelivr.net/gh/wf-ping/argon.fanfine.cn@v1.3.5/assets/vendor/headindex/headindex.js"></script>
	...
	<script src="https://cdn.jsdelivr.net/gh/wf-ping/argon.fanfine.cn@v1.3.5/assets/vendor/dragula/dragula.min.js"></script>
	<div>
		<style type="text/css">
			h2{
				font-size: 25px;
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<p class="description"><?php _e('在图片被加载之前显示的加载效果', 'argon');?> , <a target="_blank" href="https://cdn.jsdelivr.net/gh/wf-ping/argon.fanfine.cn@v1.3.5/assets/vendor/svg-loaders"><?php _e('预览所有效果', 'argon');?></a></p>
						</td>
					</tr>
